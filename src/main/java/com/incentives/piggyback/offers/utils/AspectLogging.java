package com.incentives.piggyback.offers.utils;
...
public class AspectLogging {
	...
	@Around("execution( * com.incentives.piggyback..*.*(..)) || publicNonVoidRepositoryMethod()")
	public Object around(ProceedingJoinPoint joinPoint) throws InvalidRequestException {
